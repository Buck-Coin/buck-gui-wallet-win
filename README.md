...
**The Following instruction are from the ZenCash GUI build. Instructions must be modified for the BUCK fork in this repo. 


*Buck Desktop GUI Wallet is based on ZENCash Desktop GUI Wallet*
